            ...
            onClick = {
                scope.launch {
                    ...
                    runCatching {
                        ...
                        share(DataExport.toCsv(bundle.transactions, bundle.accounts, bundle.loans, bundle.categories, bundle.smsSenders, bundle.financialAssets, bundle.stockAssets),
        ...
        OutlinedButton(
            ...
            onClick = {
                scope.launch {
                    ...
                    runCatching {
                        val bundle = viewModel.exportAll()
                        share(DataExport.toJson(bundle.transactions, bundle.accounts, bundle.loans, bundle.categories, bundle.smsSenders, bundle.financialAssets, bundle.stockAssets),
        ...
        Button(
            ...
            onClick = {
                scope.launch {
                    ...
                    runCatching {
                        val bundle = viewModel.exportAll()
                        saveToDevice(DataExport.toCsv(bundle.transactions, bundle.accounts, bundle.loans, bundle.categories, bundle.smsSenders, bundle.financialAssets, bundle.stockAssets),
                            "text/csv", "maldar-export.csv")
        ...
        OutlinedButton(
            ...
            onClick = {
                scope.launch {
                    ...
                    runCatching {
                        val bundle = viewModel.exportAll()
                        saveToDevice(DataExport.toJson(bundle.transactions, bundle.accounts, bundle.loans, bundle.categories, bundle.smsSenders, bundle.financialAssets, bundle.stockAssets),
                            "application/json", "maldar-export.json")
                        message = AppStrings.savedToDownloads
                    }.onFailure { message = it.message }
                    busy = false
